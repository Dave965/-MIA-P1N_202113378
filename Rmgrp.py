...
def com_rmgrp(params, lista_particiones, sesion_activa):
    ...
    try:
        ...
        print("--No existe el grupo con nombre '"+name+"' entre los grupos creados")
        print()
        return
    ...
    if len(usuarios_grupo) > 0:
        print("--No se puede eliminar el grupo con nombre '"+name+"' porque tiene usuarios activos")
        print()
        return
    ...
    print("Grupo '"+name+"' eliminado exitosamente")
    print()
    return
